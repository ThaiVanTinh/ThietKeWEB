...
function displayLoggedInUserInfo() {
    document.addEventListener("DOMContentLoaded", function () {
      const loggedInUserEmail = localStorage.getItem("AdminEmail");
      const loggedInUserName = localStorage.getItem("AdminName");
      const loggedInUserPhone = localStorage.getItem("AdminPhone");
      const loggedInUserGender = localStorage.getItem("AdminGender");
